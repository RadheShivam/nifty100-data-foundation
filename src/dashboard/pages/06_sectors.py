...
st.caption("Compare companies across different sectors.")
...
df = ratio_df.merge(sector_df, on="company_id", how="left")
...
df = df.merge(market_df, on="company_id", how="left")
...
st.dataframe(
    sector_data[["company_id", "company_name", "sub_sector"]].fillna("N/A"),
...
if bubble_df.empty:
    ...
    st.warning("No financial data available for this sector.")
